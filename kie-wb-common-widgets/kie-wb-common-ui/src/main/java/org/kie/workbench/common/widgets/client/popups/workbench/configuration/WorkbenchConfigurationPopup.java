...
public class WorkbenchConfigurationPopup extends BaseModal {
    ...
    private void refresh( final String selectedLanguageItem, final String selectedMultipleMode, final UserWorkbenchPreferences response ) {
        ...
        refreshWorkbench( selectedLanguageItem, refreshWorkbenchFlag, response );
    }
    ...
    private void setCurrentLanguage( final String languageName, final UserWorkbenchPreferences response ) {
    ...
    private void refreshWorkbench( final String selectedLanguageItem, boolean refreshWorkbenchFlag, final UserWorkbenchPreferences response ) {
        ...
        if (selectedLanguageItem == null || selectedLanguageItem.equals( "" )) {
            ...
            setCurrentLanguage( selectedLanguageItem, response );
        }
    }
